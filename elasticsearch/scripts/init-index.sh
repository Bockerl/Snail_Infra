...
curl -X DELETE "http://elasticsearch:9200/auth_fail_log" || true
...
curl -X PUT "http://elasticsearch:9200/auth_fail_log" -H 'Content-Type: application/json' -d "@/usr/share/elasticsearch/scripts/indices/auth_fail_log.json"
